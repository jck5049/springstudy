...
public class MyController {
	...
	/*
	 	...
	 	2. method : RequestMethod를 작성한다. (GET, POST, PUT, DELETE 등)
	 */
	/*
	 	@RequestMapping(value="/", method=RequestMethod.GET)
	 	URL Mapping이 "/"이면 context path 경로를 의미한다. (http://localhost:9090/app02)를 말한다.
	 */
	@RequestMapping(value="/", method=RequestMethod.GET)
	public String index () {
	...
	public String list() {
		...
		/*
		 	return "/board/list";	슬래시(/)로 시작한 Jsp경로
		 	실제 처리되는 경로 : /WEB-INF/views//board/list.jsp (// 2개이지만 아래 코드처럼 알아서 변한다.) 
